...
/**
 * print_elem_list - prints only the str element of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t print_elem_list(const list_t *h)
{
	size_t i = 0;
...
/**
 * free_listt - frees all nodes of a list
 * @head_ptr: address of pointer to head node
 *
 * Return: void
 */
void free_listt(list_t **head_ptr)
{
